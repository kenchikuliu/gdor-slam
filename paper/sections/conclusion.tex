...
The single-seed common-view audit is retained only as a limited preservation diagnostic: it indicates that the tracking intervention does not require degrading the declared static-region Gaussian rendering views, but it does not prove zero ghost contamination or broader mapping superiority.
