...
Published DGS-SLAM, DG-SLAM, and DyPho-SLAM values remain related-work context and are not mixed with local tables as protocol-matched reruns.
The DyPho-SLAM paper reports lower ATE on the four corresponding TUM sequences than the local DYN-18 Guarded results.
Differences in implementation, masks, preprocessing, hardware, and evaluation prevent a valid direct ranking.
An official frozen runner and matching evaluation contract are required before claiming external superiority.
